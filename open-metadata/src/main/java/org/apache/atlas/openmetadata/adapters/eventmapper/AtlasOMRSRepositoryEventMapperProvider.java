...
public class AtlasOMRSRepositoryEventMapperProvider extends OMRSRepositoryConnectorProviderBase
{
    ...
    static final String  connectorTypeGUID = "121ea5d1-2f9c-4580-9f40-442ea503b2ec";
    static final String  connectorTypeName = "OMRS Atlas Event Mapper Connector";
    static final String  connectorTypeDescription = "OMRS Atlas Event Mapper Connector that processes events from an Atlas repository.";
    /**
