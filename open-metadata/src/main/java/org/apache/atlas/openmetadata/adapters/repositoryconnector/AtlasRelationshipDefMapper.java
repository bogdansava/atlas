...
public class AtlasRelationshipDefMapper {
            ...
            RepositoryErrorException
    {
        ...
        try {
            ...
            LOG.error("AtlasRelationshipDefMapper: could not initialize metadataCollectionId");
            throw e;
        }
    }
            ...
            RepositoryErrorException
    {
        ...
        if (rcmTypeDef != null) {
            ...
            // restart - so the type has been retrieved from Atlas but the RCM does not yet have it csched.
        ...
        /*
         * Get both ends now so that we can transpose the names, descriptions and cardinailities when needed
         */
        ...
        // The attribute names, descriptions and cardinalities must be swapped end to end when converting between OM and Atlas, or vice versa
        ...
        // DESCRIPTIONGUID - is not set until after the RCM existence check....we need to know if this is a 'new' typedef
         ...
         */
        AtlasStructDef.AtlasAttributeDef.Cardinality atlasCardinality1 = ared2.getCardinality();    // attribute cardinalities are deliberately transposed between OM and Atlas
        ...
        // Note that attribute names and cardinalities must be swapped end to end when converting between OM and Atlas, or vice versa
         ...
         * relationship between a pair of entities as a one-to-one, one-to-many, many-to-one, many-to-many.
         */
        AtlasStructDef.AtlasAttributeDef.Cardinality atlasCardinality2 = ared1.getCardinality();    // attribute cardinalities are deliberately transposed between OM and Atlas
