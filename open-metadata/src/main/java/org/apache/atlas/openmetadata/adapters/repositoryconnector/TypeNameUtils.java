...
public class TypeNameUtils {
    ...
    // Utliity method to convert frm an Atlas typename to an OM primitive def category.
    // Most of the ATlas types are primitives in Atlas but DAT is not - that doesn't matter
    // as DATE is a primitive in OM so it i sjust a quesiton of mapping the Atlas DATE
