 ...
 * types is referemced it must be substituted by a type that can be stored into Atlas without
 * clashing (since the names are the same), and when one of the Atlas types is encoutered it
 ...
 *                              For Atlas persietence/lookup, name is
