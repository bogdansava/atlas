...
public class DSLQueryHelper {
            ...
            RepositoryErrorException
    {
        ...
        try {
            ...
            LOG.error("createWhereClause: re-throwing exception from createPropertyClause {}",e.getMessage());
            throw e;
        }
    }
            ...
            switch (matchCriteria) {
                ...
                default:
                    ...
                    String errorMessage = errorCode.getErrorMessageId()
                            + errorCode.getFormattedErrorMessage("matchCriteria", "matchCritera", methodName, "LocalAtlasOMRSMetadataCollection");
