...
public class TestAtlasEntityMapper {
    ...
    public void setup() {
        ...
        // TODO - you could add a more devious test that creates a TypeDef that is NOT an EntityDef
        // and then spoof the category to ENTITY_DEF using the setCategory method.
            ...
            case OK:
                ...
                if (expectedFields != null && expectedFields.get("attributes") != null) {
                    ...
                    while (expectedPropertyNames.hasNext()) {
                        ...
                        List<TypeDefAttribute> tdas = td1.getPropertiesDefinition();
                        for (TypeDefAttribute tda : tdas ) {
